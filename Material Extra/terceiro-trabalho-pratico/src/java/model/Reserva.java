...
public class Reserva{
    ...
    private boolean precoDesabilitado;
    @Future
    private Date data;
    

    public Reserva() {
        this.precoDesabilitado = false;
    }
    ...
    public boolean getPrecoDesabilitado(){
        return this.precoDesabilitado;
    }
